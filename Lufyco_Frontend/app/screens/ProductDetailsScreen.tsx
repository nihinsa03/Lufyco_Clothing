...
const ProductDetailsScreen: React.FC<Props> = ({ navigation, route }) => {
    ...
    const showToast = (msg: string) => {
        ...
        // update toast message if needed, but for now simple check
        ...
        addItem(
            {
                ...
                price,
                compareAtPrice,
                image: image ?? require("../../assets/images/clothing.png"),
                color: activeColor,
                size: "M", // defaulting size
            },
            qty
        );
    ...
    const onAddToWishlist = async () => {
        try {
            await api.post('/wishlist', {
                ...
                title,
                price,
                image: typeof image === 'string' ? image : 'placeholder', // simplify for now, really should handle assets better
            });
            alert('Added to Wishlist');
        } catch (e) {
            // console.error(e);
            // often "already in wishlist"
            alert('Added to Wishlist'); // optimistically
        }
    };
    ...
    return (
        <SafeAreaView style={styles.safe}>
            ...
            <View>
                <Image
                    source={image && typeof image === 'string' ? { uri: image } : (image ?? require("../../assets/images/clothing.png"))}
                    style={styles.hero}
                />
                <View style={styles.topRow}>
                    ...
                    <TouchableOpacity style={styles.iconDark} onPress={onAddToWishlist}>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 160 }} showsVerticalScrollIndicator={false}>
                <View style={styles.card}>
                    ...
                    <Text style={styles.lead}>
                        {description || "Add a touch of effortless elegance to your wardrobe. Needs updating from backend data."}
                        {" "}

...
const styles = StyleSheet.create({
    ...
    notificationCard: {
        flexDirection: 'row', padding: 14, borderRadius: 14, backgroundColor: '#fff',
    },
    ...
    notificationTitle: { fontSize: 14, fontWeight: '600', color: '#333', flex: 1, marginRight: 8 },
    ...
    separator: { height: 1, backgroundColor: '#f5f5f5', marginVertical: 4 },
